function kiconv() {
    ...
    function kiconv1() {
        csv({
            ...
            .then((jsonObj) => {
                ...
                fs.writeFile('kicTemp.json', '[' + finaljson.slice(0, jsonObj.length + 1) + ']', 'utf8');
            })
    ...
    function kiconv2() {
        ...
        const fs = require('fs');
        const myJson = require('./kicTemp.json')
        ...
        fs.writeFile('kicProfiles.csv', csv, 'utf8');
        fs.unlink("./kicTemp.json");
    };
