...
function ssconv1() {
    csv({
        ...
        .then((jsonObj) => {
            ...
            fs.writeFile('soleSlayerTemp.json', '[' + finaljson.slice(0, jsonObj.length + 1) + ']', 'utf8');
        })
...
function ssconv2() {
    ...
    const fs = require('fs');
    const myJson = require('./soleSlayerTemp.json')
    ...
    fs.writeFile('soleSlayerProfiles.csv', tsv, 'utf8');
    fs.unlink("./soleSlayerTemp.json");
};
